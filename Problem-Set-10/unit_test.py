...
EXERCISE_OR_ASSIGNMENT_NAME = "exercise10"
...
class TestLab(unittest.TestCase):
    def test_question1(self):
        self.assertIsInstance(Tribonacci()(5), int)

    def test_question2(self):
        self.assertIsInstance(CoinChange()(10), list)
        self.assertIsInstance(CoinChange()(10)[0], list)
        self.assertIsInstance(CoinChange()(10)[0][0], int)

    def test_question3(self):
        self.assertIsInstance(Collatz()(10), tuple)
        self.assertIsInstance(Collatz()(10)[0], int)
        self.assertIsInstance(Collatz()(10)[1], int)

    def test_question4(self):
        self.assertIsInstance(knapsack1(1, [(1, 5), (2, 4)]), np.ndarray)
        self.assertIsInstance(knapsack1(1, [(1, 5), (2, 4)])[0,0], (int, np.int64, np.int32))

        self.assertIsInstance(knapsack2(1, [(1, 5), (2, 4)]), tuple)
        self.assertIsInstance(knapsack2(1, [(1, 5), (2, 4)])[0], np.ndarray)
        self.assertIsInstance(knapsack2(1, [(1, 5), (2, 4)])[0][0,0], (int, np.int64, np.int32))
        self.assertIsInstance(knapsack2(1, [(1, 5), (2, 4)])[1], dict)
        self.assertIsInstance(knapsack2(1, [(1, 5), (2, 4)])[1][0,0], list)
        self.assertIsInstance(list(knapsack2(1, [(1, 5), (2, 4)])[1].keys())[0], tuple)

    def test_question5(self):
        for rod_func in [RodCuttingDivideAndConquer(), RodCuttingDynamicProgramming(), rod_cutting_dynamic_programming]:
            self.assertIsInstance(rod_func([0, 2, 3, 5], 3), (int, np.int64, np.int32))
